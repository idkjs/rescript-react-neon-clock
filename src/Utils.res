@ocaml.doc(" Identity function ")
let /* this is a helper function to transform our current time into the a format we can use in our other modules. We have to do this 2 or 3 times so better to do it once. */

globalTime = (~time: float) => {
